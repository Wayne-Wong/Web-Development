...
<html>
<head>
	<title>TCEQ Table of Contents</title>
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="active"><a href="https://www.tceq.texas.gov/"><span class="glyphicon glyphicon-home" aria-hidden="true"></span> TCEQ Homepage</a></li>
      </ul>
...
<div class="container">
  <div class="jumbotron" id="jumbo">
    <h1 id="title-font">The Agency Data Standards Training!</h1> 
    <h2 id="header-font">Table of contents:</h2> 
    ...
    <tbody>
      <tr>
        <td>0.</td>
        <td><a href="../chapter_intro/intro.aspx" style="color:black" target="_blank">Introduction</a></td>
        <td>(3:45 mins)</td>
      </tr>
   
      <tr>
        <td>1.</td>
        <td><a href="chapter1.aspx" style="color:black" target="_blank">Data Dictionary</a></td>
        <td>(5:12 mins)</td>
      </tr>
 
      <tr>
        <td>2.</td>
        <td><a href="chapter2.aspx" style="color:black" target="_self">Punctuation and Abbreviation</a></td>
        <td>(3:56 mins)</td>
      </tr>

      <tr>
        <td>3.</td>
        <td style="color: #994F4F">Street and Directional Standards</a></td>
        <td>(5:32 mins)</td>
      </tr>
  
      <tr>
        <td>4.</td>
        <td style="color: #994F4F">Basic Name Principles and Guidelines</a></td>
        <td>(6:22 mins)</td>
      </tr>

      <tr>
        <td>5.</td>
        <td style="color: #994F4F">Customer and Regulated Entity Names</a></td>
        <td>(N/A)</td>
      </tr>

      <tr>
        <td>6.</td>
        <td style="color: #994F4F">Issues-To and Additional IDs</a></td>
        <td>(N/A)</td>
      </tr>

      <tr>
        <td>7.</td>
        <td style="color: #994F4F">Validating Addresses</a></td>
        <td>(N/A)</td>
      </tr>
    </tbody>
