...
<div class="container">
  <div class="jumbotron" id="jumbo">
    <h2 id="header-font">Chapter 1: Data Dictionary</h2> 
    
<form onsubmit="OpenWindow()" id="page1" action="javascript:OpenWindow()" method="post" name="my_form" class="tceq-test">

  <div class="radio">1. This is just a placeholder, not a real question.</div>
  ...
  <div class="radio">2. This is just a placeholder, not a real question.</div>
    <label class="radio"></label>
  ...
  <div class="radio">3. This is just a placeholder, not a real question.</div>
    <label class="radio"></label>
  ...
  <script type="text/javascript">
    function OpenWindow() {
      ...
      if ((ans1 === 'D') && (ans2 === 'D') && (ans3 === 'D')) {
        alert("Good job!");
        window.open("../chapter_2/toc.aspx", "_self");
      } else {
        alert("Sorry, please check your answers.");
        window.open("chapter1_test.aspx", "_self");
      }    
