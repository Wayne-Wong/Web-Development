  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="toc.aspx"><span class="glyphicon glyphicon-triangle-left" aria-hidden="true"></span> Go back </a></li>
        <li id="test_timer" style="display:none;"><a href="chapter1_test.aspx"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Test </a></li>
        <li class="dropdown">
...
<div class="container">
  <div class="jumbotron" id="jumbo">
    <h1 id="title-font">Chapter 2: Punctuation and Abbreviation</h1> 
    ...
    <script type="text/javascript">
      $(document).ready(function(){   
       $("#myVideo").bind('ended', function(){
          location.href="chapter2_test.aspx";   
       }); 
      });
    </script>

    <iframe id="myVideo" class="tscplayer_inline" name="tsc_player" src="Chapter1_player.html" scrolling="no" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe> 
