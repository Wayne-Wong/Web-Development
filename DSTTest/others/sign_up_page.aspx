  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="loginpage.html"><span class="glyphicon glyphicon-log-in" aria-hidden="true"></span> Login</a></li>    
      </ul>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
</nav>
...
<div class="container">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputEmpID" placeholder="Enter your 6 digits employee ID" required>
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <button onclick="signup_func()" type="submit" class="btn btn-warning btn-lg"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Sign up</button>
    </div>
  </div>
</form>
</div>
	<script type="text/javascript">
      ...
      var user = document.getElementById("inputFirstName").value;
      var user = document.getElementById("inputLastName").value;
			var user = document.getElementById("inputEmpID").value;
			var pass = document.getElementById("inputPassword").value;

			alert("Your account has been created. You may login now.");
      var hWndB = window.open('loginpage.html'),
          hWndA = window.self;
