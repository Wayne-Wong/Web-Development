...
<div class="container">
  <div class="jumbotron" id="jumbo">
    <h1 id="title-font">Chapter 1: Data Dictionary</h1> 
    ...
    <script type="text/javascript">
      $(document).ready(function(){   
       $("#myVideo").bind('ended', function(){
          location.href="chapter1_test.aspx";   
       }); 
      });
    </script>

    <iframe class="tscplayer_inline" name="tsc_player" src="Chapter1_player.html" scrolling="no" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe> 
