...
$username = "kwan1238_rest";
$password = "TheBest4inUNT";
$db = "kwan1238_4901";

$conn = mysqli_connect($servername, $username, $password, $db);

$username = $_SESSION['username'];
$query = "Select * from `inventory` where `addbyuser` = '$username' "; 
...
while ($row = mysqli_fetch_array($results)) {
    ...
    $pieData[] = array($row['product_name'], $row['quantity']);
}
?>
...
function drawChart()
{
    ...
    var options = {'title':'All user Inventory with Products and Quantity',
                           is3D: true,
                           'width':1500,
                           'height':700,
