        ...
        <div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown">
						<a href="addproduct.php?type=showall" class="dropdown-toggle" data-toggle="dropdown">
							Product
							<b class="caret"></b>
						</a>
							<ul class="dropdown-menu">
...
$update="update suppliers set supplier_name='".$supplier_name."', address='".$address."', city='".$city."', state='".$state."', zip='".$zip."', phone='".$phone."', email='".$email."', addbyuser='".$addbyuser."' where id='".$id."'";
...
<div class="container">
                	<div class="storeinfo">
					<p style="font-size:200%;">Edit Supplier Information</p>
					</div>
</div>
<center>
<div class="form">
...
<input type="hidden" name="new" value="1" />
    <table width="90%" border="0" cellspacing="0" cellpadding="6">
      <tr>
        ...
        <td width="80%"><label>
          <input name="supplier_name" type="text" size="64" required value="<?php echo $row['supplier_name'];?>" />
        </label></td>
      </tr>
		<tr>
      ...
      <tr>
        ...
        <td width="80%"><label>
          <input name="email" type="text" size="64" required value="<?php echo $row['email'];?>" />
        </label></td>
      </tr>    
      <tr>
        <td>&nbsp;</td>
        <td><label>
          <input type="submit" class="btn btn-default btn-md" name="submit" value="Update Supplier Now"/>
        </label></td>
      </tr>
    </table>
    </form>
